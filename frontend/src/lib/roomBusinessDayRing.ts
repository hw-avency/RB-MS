...
export const BUSINESS_MINUTES = BUSINESS_END_MINUTES - BUSINESS_START_MINUTES;
...
export const BUSINESS_START_ANGLE_RADIANS = clockHourToAngleRadians(BUSINESS_START_MINUTES / 60);
